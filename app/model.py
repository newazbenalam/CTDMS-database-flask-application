...
class Person(db.Model):
    ...
    race_id = db.Column(db.String(11))
    ethnicity_id = db.Column(db.Integer)
    location_id = db.Column(db.Integer, db.ForeignKey('location.location_id'), nullable=True)
    care_site_id = db.Column(db.Integer, db.ForeignKey('location.location_id'), nullable=True)
...
class Phase(db.Model):
    ...
    phase_number = db.Column(db.String(10), nullable=False)
