...
function darkMode(e) {
  ...
  const isDarkMode = body.classList.toggle("dark-version"); // Toggle the 'dark-version' class
  const localStorageKey = "darkMode"; // Key for localStorage
  ...
  if (e.getAttribute("checked")) {
    ...
    a.classList.remove('bg-white'); // Remove the class for dark mode styling
  } else {
    var q;
    a.classList.add('bg-white'); // Remove the class for dark mode styling
